...
function LoginScreen() {
  ...
  useEffect(() => {
    timerRef.current = setTimeout(() => navigation.navigate('MainTabs'), 2000);
  ...
  return (
    <Body>
      <Block flex={1} p="24px" bgColor="#F7F5F7">
        <Text h3 center m="50px 0" p="50px 0 0">
          Sign in
        </Text>

        <Block m="20px 0 0">
          <Text weight="bold" m="0 0 5px">
            Email ID
          </Text>
